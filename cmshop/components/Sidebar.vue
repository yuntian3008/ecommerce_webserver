<template>
  <transition enter-active-class="animate-bounceInLeft animate-duration-600" leave-active-class="animate-bounceOutLeft animate-duration-600">
      ...
      <div
        ...
        <ul class="space-y-2">
          <li>
            <NuxtLink to="/" @click.native="clickOut"
          ...
          <li>
            <button type="button" @click="$refs.pages.classList.toggle('hidden')"
              ...
              <span class="flex-1 ml-3 text-left whitespace-nowrap">Nội dung</span>
            ...
            <ul id="dropdown-pages" ref="pages" class="hidden py-2 space-y-2">
              <li>
                <NuxtLink to="/content/category" @click.native="clickOut"
          ...
          <li>
            <button type="button" @click="$refs.dropdownSales.classList.toggle('hidden')"
              class="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
              ...
              <span class="flex-1 ml-3 text-left whitespace-nowrap">Việc bán hàng</span>
              <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
                  d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
            ...
            <ul ref="dropdownSales" class="hidden py-2 space-y-2">
              ...
              <li>
                <a href="#"
                  class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Thống kê bán hàng</a>
              </li>
              <li>
                <a href="#"
                  class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Thông kê doanh thu</a>
              </li>
            </ul>
          </li>
          <!-- <li>
          ...
          <li>
            <button type="button" @click="$refs.dropdownAuthentication.classList.toggle('hidden')"
              class="flex items-center p-2 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
              ...
              <span class="flex-1 ml-3 text-left whitespace-nowrap">Tài khoản</span>
              <svg aria-hidden="true" class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
                  d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
      ...
      <div
        ...
        <button type="button" @click="$refs.languageDropdown.classList.toggle('hidden')"
        ...
        <!-- Dropdown -->
        <div
          class="hidden z-50 my-4 text-base list-none bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 absolute bottom-0 left-0"
