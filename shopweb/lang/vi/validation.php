...
return [
    ...
    'declined' => 'Trường :attribute phải mang nghĩa "không"',
    'declined_if' => 'Trường :attribute phải mang nghĩa "không" khi :other là :value.',
    ...
    'min_digits' => 'Trường :attribute không được ít hơn :min chữ số.',
    ...
    'password' => [
        ...
        'uncompromised' => 'Trường :attribute này đã xuất hiện trong một vụ rò rỉ dữ liệu. Vui lòng chọn một trường khác :attribute.',
    ],
    ...
    'prohibits' => 'Trường :attribute này cấm các trường :other hiện diện.',
    'regex'                => 'Trường :attribute có định dạng không hợp lệ.',
    'required'             => 'Trường :attribute không được bỏ trống.',
    'required_array_keys' => 'Trường :attribute phải chứ các mục: :values.',
    ...
    */
    ...
    'custom' => [
        'slug' => [
            'unique' => 'Đường dẫn ngẫu nhiên trùng hợp hi hữu, vui lòng thử lại lần nữa.',
        ],
    ],
